...
// BOH
#include "BOHAbilityTagRelationshipMapping.generated.h"

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FBOHAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class BOH_API UBOHAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY(EditAnywhere, Category = Ability)
	TArray<FBOHAbilityTagRelationship> m_abilityTagRelationships;
